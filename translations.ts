...
export const translations: Record<string, Record<Language, string>> = {
  ...
  subtitle: {
    he: "בואו נעקוב ביחד אחרי המצב היום",
    en: "Let's track the status together today",
  },

  userInfoTitle: { he: "לפני שמתחילים...", en: "Before we start..." },
  yourName: { he: "שם המדווח/ת", en: "Reporter Name" },
  yourRelation: { he: "קרבה למטופל/ת", en: "Relation to Patient" },
  reportReason: { he: "סיבת הדיווח", en: "Reason for Reporting" },
  reasonPlaceholder: {
    he: "למשל: מעקב שבועי, החמרה במצב...",
    en: "e.g. Weekly follow-up, worsening...",
  },

  // New: Emergency
  emergencyTitle: { he: "רפואה דחופה", en: "Emergency Care" },
  emergencyDesc: {
    he: "תאר/י את הבעיה הדחופה",
    en: "Describe the urgent issue",
  },
  enterCity: { he: "הקלד שם יישוב", en: "Enter city name" },
  searchClinics: { he: "חפש מרפאות", en: "Search Clinics" },
  noClinicsFound: {
    he: "לא נמצאו מרפאות ביישוב זה",
    en: "No clinics found in this city",
  },
  ...
  summaryText1: {
    he: "ביקור מעקב שגרתי. נצפתה יציבות קוגניטיבית. אין שינוי במינון תרופתי. מומלץ להמשיך מעקב לחץ דם בבית.",
    en: "Routine follow-up. Cognitive stability observed. No change in medication dosage. Continue home blood pressure monitoring recommended.",
  },
  summaryText2: {
    he: "תלונה על נדודי שינה. הומלץ על שינוי סביבת השינה והפחתת קפאין בערב.",
    en: "Complaint of insomnia. Recommended changing sleep environment and reducing caffeine in the evening.",
  },
  sensitivityTitle: { he: "רגישויות ידועות", en: "Known Sensitivities" },
  penicillin: { he: "פניצילין", en: "Penicillin" },
  reactionRash: {
    he: "תגובה: פריחה עורית וקוצר נשימה",
    en: "Reaction: Skin rash and shortness of breath",
  },
  sulfa: { he: "סולפה", en: "Sulfa" },
  reactionNausea: {
    he: "תגובה: בחילות והקאות חריפות",
    en: "Reaction: Severe nausea and vomiting",
  },
  uploadBtn: { he: "בחר קובץ להעלאה", en: "Choose file to upload" },
  uploadInstruction: {
    he: "ניתן להעלות סיכומי ביקור, תוצאות בדיקות דם או מרשמים סרוקים (PDF/JPG)",
    en: "Upload visit summaries, blood test results, or scanned prescriptions (PDF/JPG)",
  },
  ...
  vibeQuestion: {
    he: "איך המטופל/ת מרגיש/ה היום?",
    en: "How is the patient feeling today?",
  },
  vibeGood: { he: "מצוין, אין שינוי", en: "Great, no change" },
  vibeNotGood: { he: "לא כל כך טוב...", en: "Not so good..." },
  doctorFeedback: {
    he: "תגובת פסיכוגריאטר",
    en: "Psychogeriatrician Response",
  },
  // Add these to your translations.ts file
  vibeSuccessTitle: { he: "טוב לשמוע!", en: "Great to hear!" },
  vibeSuccessMessage: {
    he: "נשמח שתעדכנו אותנו בכל פעם שחל שינוי או אם תרצו לתעד יום מוצלח במיוחד.",
    en: "Feel free to update us whenever there’s a change or if you’d like to document a particularly good day.",
  },
  backToHome: { he: "חזרה לדף הבית", en: "Back to Home" },
  videoCall: { he: "שיחת וידאו דחופה", en: "Urgent Video Call" },
  expedite: { he: "זירוז תור קיים", en: "Expedite Appointment" },
  noMessages: {
    he: "אין הודעות חדשות מהצוות.",
    en: "No new messages from the staff.",
  },
  ...
  analyzing: {
    he: "מנתח נתונים בבינה מלאכותית...",
    en: "AI is analyzing clinical data...",
  },
  medicalInfoTitle: {
    he: "מידע למטופל ולמשפחה",
    en: "Patient & Family Information",
  },
  medicalInfoSubtitle: {
    he: "לחיות לצד דמנציה ואלצהיימר",
    en: "Living with Dementia & Alzheimer's",
  },

  // New Pages Content
  recentActivity: { he: "פעילות אחרונה במערכת", en: "Recent System Activity" },
  doctorName: {
    he: 'ד"ר כהן - פסיכוגריאטר',
    en: "Dr. Cohen - Psychogeriatrician",
  },
  clinicHours: {
    he: "שעות קבלה: א-ה, 08:00-14:00",
    en: "Hours: Sun-Thu, 08:00-14:00",
  },
  callClinic: { he: "התקשר למרפאה", en: "Call Clinic" },
  videoTutorial: {
    he: "סרטון הדרכה לשימוש באפליקציה",
    en: "App Usage Tutorial Video",
  },
  playVideo: { he: "נגן סרטון", en: "Play Video" },
  supportCenter: { he: "מוקד תמיכה טלפוני", en: "Phone Support Center" },
  available247: {
    he: "זמין 24/7 לכל שאלה",
    en: "Available 24/7 for any question",
  },
  dialNow: { he: "חייג עכשיו", en: "Dial Now" },

  // Medical Content Sections
  infoWhatIsTitle: {
    he: "מהי דמנציה ומהו אלצהיימר?",
    en: "What is Dementia and Alzheimer's?",
  },
  infoWhatIsContent: {
  ...
  infoSymptomsTitle: {
    he: "תסמינים ומהלך המחלה",
    en: "Symptoms & Disease Progression",
  },
  infoSymptomsContent: {
  ...
  infoDisorientationTitle: {
    he: "חוסר התמצאות במרחב",
